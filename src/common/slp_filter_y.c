...
{
       0,   137,   137,   137,   139,   169,   179,   184,   189,   189,
     189,   194,   209,   225,   241,   257,   257,   257,   257
};
#endif
...
/* Line 1455 of yacc.c  */
#line 140 "slp_filter_y.y"
    { 
   if(0 != ((yyval.filter_filter) = SLPAllocFilter((yyvsp[(2) - (4)].filter_int))))
   {
      ...
      if(!SLP_IS_EMPTY(&reducedFilters) )
      {
         ...
         while(!SLP_IS_HEAD(temp))
         {
            if(temp->nestingLevel == nesting_level + 1)
            {
               ...
               temp = temp->next;
               SLP_UNLINK(nest);
               SLP_INSERT_BEFORE(nest, (SLPLDAPFilter *)&((yyval.filter_filter)->children)) ;
            }
            else
            {
               temp = temp->next;
         ...
         SLP_INSERT_BEFORE( (filterHead *)(yyval.filter_filter), &reducedFilters);
      }
      else
      {
         SLPFreeFilter((yyval.filter_filter)) ; (yyval.filter_filter) = 0 ;
      }
   }
}
    break;
...
/* Line 1455 of yacc.c  */
#line 170 "slp_filter_y.y"
    { 
   (yyval.filter_filter) = (yyvsp[(2) - (3)].filter_filter);
   if((yyvsp[(2) - (3)].filter_filter) != 0)
   {
      (yyvsp[(2) - (3)].filter_filter)->nestingLevel = nesting_level;
      SLP_INSERT_BEFORE((filterHead *)(yyvsp[(2) - (3)].filter_filter), &reducedFilters) ; 
   }
}
    break;
...
/* Line 1455 of yacc.c  */
#line 190 "slp_filter_y.y"
    { 
   (yyval.filter_int) = yylval.filter_int; 
}
    break;
...
/* Line 1455 of yacc.c  */
#line 195 "slp_filter_y.y"
    {      /* presence test binds to single operand */
   if(0 != ((yyval.filter_filter) = SLPAllocFilter(expr_present)))
   {
      SLPAttrList *attr = SLPAllocAttr((yyvsp[(1) - (2)].filter_string), string, "*", (int)strlen("*") + 1);
      if(attr != 0)
      {
         SLP_INSERT(attr, &((yyval.filter_filter)->attrs));
      }
      else
      {
         SLPFreeFilter((yyval.filter_filter)); (yyval.filter_filter) = 0;
...
/* Line 1455 of yacc.c  */
#line 210 "slp_filter_y.y"
    {  /* must be an int or a bool */
   /* remember to touch up the token values to match the enum in SLP.h */
   if(0 != ((yyval.filter_filter) = SLPAllocFilter((yyvsp[(2) - (3)].filter_int))))
   {
      SLPAttrList *attr = SLPAllocAttr((yyvsp[(1) - (3)].filter_string), integer, &((yyvsp[(3) - (3)].filter_int)), sizeof((yyvsp[(3) - (3)].filter_int)));
      if(attr != 0)
      {
         SLP_INSERT(attr, &((yyval.filter_filter)->attrs));
      }
...
/* Line 1455 of yacc.c  */
#line 226 "slp_filter_y.y"
    {  /* must be an int or a bool */
   /* remember to touch up the token values to match the enum in SLP.h */
   if(0 != ((yyval.filter_filter) = SLPAllocFilter((yyvsp[(2) - (3)].filter_int))))
   {
      SLPAttrList *attr = SLPAllocAttr((yyvsp[(1) - (3)].filter_string), boolean, &((yyvsp[(3) - (3)].filter_int)), sizeof((yyvsp[(3) - (3)].filter_int)));
      if(attr != 0)
      {
         SLP_INSERT(attr, &((yyval.filter_filter)->attrs));
      }
...
/* Line 1455 of yacc.c  */
#line 242 "slp_filter_y.y"
    {  /* both operands are strings */
   if(0 != ((yyval.filter_filter) = SLPAllocFilter((yyvsp[(2) - (3)].filter_int))))
   {
      SLPAttrList *attr = SLPAllocAttr((yyvsp[(1) - (3)].filter_string), string, (yyvsp[(3) - (3)].filter_string), (int)strlen((yyvsp[(3) - (3)].filter_string)) + 1 );
      if(attr != 0)
      {
         SLP_INSERT(attr, &((yyval.filter_filter)->attrs));
      }
