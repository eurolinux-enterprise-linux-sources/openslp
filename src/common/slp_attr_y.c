...
{
      15,     0,    -1,    16,    -1,    15,    10,    16,    -1,     8,
      -1,    11,     8,    12,    -1,    11,     8,    13,    17,    12,
      -1,    18,    -1,    17,     5,    18,    -1,     3,    -1,     4,
      -1,     7,    -1,     9,    -1,     6,    -1
};
...
{
       0,   133,   133,   144,   156,   164,   172,   184,   191,   199,
     203,   207,   212,   216
};
#endif
...
{
      -6,   -12,    -2,     0,   -12,    -9,   -12,    -6,   -12,     8,
     -12,   -12,   -12,   -12,   -12,   -12,    -4,   -12,     8,   -12,
     -12
};
...
{
       6,    18,     1,     8,     9,     2,     5,    20,    19,    10,
       7,    11,    12,     0,    13,    14,     0,    15
};

static const yytype_int8 yycheck[] =
{
       0,     5,     8,    12,    13,    11,     8,    18,    12,     7,
      10,     3,     4,    -1,     6,     7,    -1,     9
};
...
{
       0,     8,    11,    15,    16,     8,     0,    10,    12,    13,
      16,     3,     4,     6,     7,     9,    17,    18,     5,    12,
      18
};
...
/* Line 1455 of yacc.c  */
#line 157 "slp_attr_y.y"
    {
   (yyval._atl) =  SLPAllocAttr((yyvsp[(1) - (1)]._s), tag, 0, 0);
   if ( 0 != (yyval._atl) )
   {
...
/* Line 1455 of yacc.c  */
#line 165 "slp_attr_y.y"
    {
   (yyval._atl) =  SLPAllocAttr((yyvsp[(2) - (3)]._s), tag, 0, 0);
   if (0 != (yyval._atl))
   {
      SLP_INSERT_BEFORE((yyval._atl), &inProcessAttr);
   }
...
#line 185 "slp_attr_y.y"
   ...
   if(0 != (yyvsp[(1) - (1)]._atl))
   {
      SLP_INSERT((yyvsp[(1) - (1)]._atl), &inProcessTag);
   }
}
    break;
...
/* Line 1455 of yacc.c  */
#line 192 "slp_attr_y.y"
    {
   if (0 != (yyvsp[(3) - (3)]._atl))
   {
      SLP_INSERT_BEFORE((yyvsp[(3) - (3)]._atl), &inProcessTag);
   }
}
    break;
...
/* Line 1455 of yacc.c  */
#line 200 "slp_attr_y.y"
    {
   (yyval._atl) = SLPAllocAttr(0, boolean, &bt, sizeof(int));
}
    break;
...
/* Line 1455 of yacc.c  */
#line 204 "slp_attr_y.y"
    {
   (yyval._atl) = SLPAllocAttr(0, boolean, &bf, sizeof(int));
}
    break;
...
/* Line 1455 of yacc.c  */
#line 208 "slp_attr_y.y"
    { 
   /* treat it as a string because it is already encoded */
   (yyval._atl) = SLPAllocAttr(0, string, (yyvsp[(1) - (1)]._s), strlen((yyvsp[(1) - (1)]._s)) + 1);
}
    break;
...
/* Line 1455 of yacc.c  */
#line 217 "slp_attr_y.y"
    {
   (yyval._atl) = SLPAllocAttr(0, integer, &((yyvsp[(1) - (1)]._i)), sizeof(int));
}
    break;
